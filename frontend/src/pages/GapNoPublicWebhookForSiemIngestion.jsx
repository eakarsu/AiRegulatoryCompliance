...
export default function GapNoPublicWebhookForSiemIngestion() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-webhook-for-siem-ingestion', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No public webhook for SIEM ingestion</h1>
