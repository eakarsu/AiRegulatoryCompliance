...
export default function GapLimitedWorkflowAutomationActionAssignmen() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-workflow-automation-action-assignmen', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Limited workflow automation (action assignment, due dates)</h1>
